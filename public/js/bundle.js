      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              _sweetalert.default.fire((_Swal$fire = {
                position: 'top',
                title: 'Thank you',
                icon: 'success'
              }, _defineProperty(_Swal$fire, "title", 'Logged out successfully'), _defineProperty(_Swal$fire, "showConfirmButton", false), _defineProperty(_Swal$fire, "backdrop", "\n    rgba(0,0,123,0.4)\n    url(\"/img/nyan-cat.gif\")\n    left top\n    no-repeat\n  "), _Swal$fire)); // showAlert('success', 'Logged out successfully');
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","./alert.js":"alert.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your data are successfully updated');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(curPass, newPass, conPass) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your password has been updated');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"signUp.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"password.js":[function(require,module,exports) {
"use strict";
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, passwordConfirm, token, email) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/resetPassword/".concat(email, "?token=").concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
  ...
  return function resetPassword(_x2, _x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var forgotForm = document.querySelector('.form--forgotPassword');
...
if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    ...
    var token = document.querySelector('.btn--new--pass').dataset.token;
    (0, _password.resetPassword)(password, passwordConfirm, token, email);
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateMe)(form);
  });
}
